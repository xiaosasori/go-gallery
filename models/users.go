...
type UserService interface {
	...
	// password. If they are correct, the user corresponding to
...
// BbyEmail will normalize the email address before calling
...
// brcryptPassword will hash a user's password with a
...
func (uv *userValidator) emaiIsAvail(user *User) error {
	...
	// an update and this is the same uesr.
